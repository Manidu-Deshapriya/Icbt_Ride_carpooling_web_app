        ...
        html += `
            <div class="list-item">
                <div class="list-item-header">
                    ...
                    <span class="badge" style="background: rgba(27, 94, 32, 0.1); color: var(--primary-color);">${ride.seats} Seats Left</span>
                </div>
            </div>
        `;
    });
    ...
    function handleFileUpload(inputElement, statusElement, docType) {
        ...
        inputElement.addEventListener('change', (e) => {
            ...
            reader.onload = (event) => {
                ...
                // Save Base64 hash directly to Firestore
                db.collection('drivers').doc(driverId).set({
                    [docType + 'Url']: base64String,
                ...
                .then(() => {
                    ...
                    statusElement.innerHTML = '<span style="color: var(--danger-color);"><i class="fa-solid fa-circle-exclamation"></i> Upload failed.</span>';
                });
            };
            
            reader.onerror = (error) => {
                console.error("Error reading file:", error);
                statusElement.innerHTML = '<span style="color: var(--danger-color);"><i class="fa-solid fa-circle-exclamation"></i> Error processing image.</span>';
            };
        });
    }
